...
class Profile2_form(forms.ModelForm):
    class Meta:
        model = profile
        fields = [ 'address','roll_no','marks','image','attendence','document10','document12','document_last_sem','father_id','father_name' ,'father_rank','student_id']

        widgets = {
            #'branch':forms.TextInput(attrs={'readonly':True,'class':'form-control form-control-alternative'}),
