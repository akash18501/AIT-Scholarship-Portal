...
def file_size1(value): # add this to some file where you can import it from
    limit =  1024*1024
    if value.size > limit:
...
class profile(models.Model):
    ...
    image= models.ImageField(upload_to='pics/profile_pics',default='pics/profile_pics/default.png',validators=[file_size1])
    roll_no=models.IntegerField(default=0)
    address=models.CharField(max_length=50,default='')
    document10 = models.FileField(upload_to='documents/user_documents/10marksheets',blank=True,null=True,validators=[file_size1])
    document12 = models.FileField(upload_to='documents/user_documents/12marksheets',blank=True,null=True,validators=[file_size1])
    document_last_sem = models.FileField(upload_to='documents/user_documents/last_marksheets',blank=True,null=True,validators=[file_size1])
    father_id = models.FileField(upload_to='documents/user_documents/father_id',blank=True,null=True,validators=[file_size1])
    student_id = models.FileField(upload_to='documents/user_documents/student_id',blank=True,null=True,validators=[file_size1])
    ...
    #     self.document_last_sem.delete()
    #     self.document12.delete()
    #     self.document10.delete()
    #     self.student_id.delete()
    #     self.father_id.delete()
    #     self.image.delete()
