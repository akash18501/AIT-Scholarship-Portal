...
class scholarship(models.Model):
    ...
    img=models.ImageField(upload_to='pics/scholarship_pics',default='pics/scholarship_pics/default.png',validators=[file_size1])
    ...
    scholarship_form = models.FileField(upload_to='documents/scholarship_form/',
                                        default='documents/scholarship_form/default_scholarship_form.pdf',validators=[file_size2])
...
class application_table(models.Model):
    ...
    applied_extra1 = models.FileField(upload_to='applications/extra1',blank=True,null=True,validators=[file_size1])
    applied_extra2 = models.FileField(upload_to='applications/extra2',blank=True,null=True,validators=[file_size1])
    applied_scholarship_form = models.FileField(upload_to='applications/applied_scholarship_form', blank=True,
                                                null=True,validators=[file_size2])
