...
urlpatterns = [
    ...
    url(r'^show_scholarship_template/scholarship_application_form/(?P<x>[0-9]+)/$', views.pdf_view2,
        name='show-scholarship-form'),
    url(r'^show_scholarship_template/applied_scholarship_application_form/(?P<x>[0-9]+)/$', views.pdf_view3,
        name='show-applied_scholarship-form'),

    url(r'^simple_export_admin_pannel/(?P<x>[0-9]+)/$', views.simple_export_admin_pannel,
        name='simple_export_admin_pannel'),
